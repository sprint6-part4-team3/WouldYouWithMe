...
const Section2 = () => {
  ...
  return (
    <section
      ref={ref}
      className="mt-3 flex h-screen w-full flex-col items-center justify-evenly md:gap-0 lg:mt-0 lg:flex-row lg:justify-evenly"
    >
      <motion.article
      ...
      <motion.div
        ...
        className="flex h-1/5 w-4/5 min-w-230 max-w-700 justify-center md:size-2/3 lg:size-1/2"
      >
